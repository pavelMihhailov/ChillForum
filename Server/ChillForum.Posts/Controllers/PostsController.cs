namespace ChillForum.Posts.Controllers
{
    ...
    public class PostsController : ApiController
    {
        ...
        [HttpGet]
        public async Task<IList<PostOutputModel>> AllPostsOfProfile(int id)
        {
            var posts = this.mapper.Map<List<PostOutputModel>>(await this.posts.GetAll());

            return posts.Where(x => x.AuthorId == id).ToList();
        }
